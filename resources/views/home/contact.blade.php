        ...
        <div class="p-5">
            ...
            <div id="default-styled-tab-content">
                ...
                <div class="hidden rounded-lg  text-white dark:text-gray-100" id="styled-appointment" role="tabpanel" aria-labelledby="appointment-tab">
                        ...
                        <a href="" class="block bg-orange-500 dark:bg-orange-600 text-white text-center text-xl font-bold rounded-lg p-3 w-full" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/accounts-jeffreyzeller'});return false;">Book an Meeting</a>
