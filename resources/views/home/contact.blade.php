    ...
    <div class="max-w-lg mx-auto text-left">
        <div class="p-5 sm:p-0">
            <div class="mb-4 border-b-1 border-gray-100 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" data-tabs-active-classes="text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500" data-tabs-inactive-classes="dark:border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300" role="tablist">
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-5 rounded-t-lg bg-white" id="message-styled-tab" data-tabs-target="#styled-message" type="button" role="tab" aria-controls="message" aria-selected="false">
                            Message Me
                        </button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-5 rounded-t-lg bg-white hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="appointment-styled-tab" data-tabs-target="#styled-appointment" type="button" role="tab" aria-controls="appointment" aria-selected="false">
            ...
            <div id="default-styled-tab-content">
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-message" role="tabpanel" aria-labelledby="message-tab">
                    ...
                    <form id="contact-form" class="p-5" action="{{ route('contact.submit') }}" method="POST">
                        ...
                        <button class="bg-blue-700 text-white rounded-b-lg p-3 w-full" type="submit">
                            Submit
                        </button>
                    </form>
                </div>
                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-appointment" role="tabpanel" aria-labelledby="appointment-tab">
                    ...
                    <a href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/accounts-jeffreyzeller'});return false;">Schedule an Appointment</a>
