<section id="about" class="w-full text-center content-center bg-white/90 dark:bg-slate-950/80 snap-start min-h-[calc(100vh)] bg-[url({{ asset('images/bg-wave-trans-flipped.svg') }})] dark:bg-[url({{ asset('images/bg-wave-dark-trans-flipped.svg') }})] bg-cover bg-no-repeat bg-top pt-75">
    <h2 class="text-4xl text-blue-700 dark:text-gray-100 font-bold mb-5">Crafting Secure, Purpose-Built Web Apps for Modern Businesses.</h2>
    <div class="max-w-5xl mx-auto flex flex-col sm:flex-row p-5">
        <div class="flex-1 p-5 bg-white/100 shadow shadow-lg mr-5 dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-left rounded-xl outline-blue-500/50 outline-4 outline-offset-5">
            ...
            <a href="#contact" class="text-blue-500 hover:underline">Let’s Build Your Custom Web App →</a><br />
            <a href="#contact" 
