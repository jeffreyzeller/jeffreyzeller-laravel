...
<nav class="bg-blue-500 dark:bg-gray-800  fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="font-medium flex flex-col p-2 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-200 shadow-inner shadow-gray-900 dark:shadow-slate-400/75 md:flex-row md:space-x-1 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-gray200/10 dark:bg-gray-800 dark:border-gray-700">
            <li class="px-3 py-2">
